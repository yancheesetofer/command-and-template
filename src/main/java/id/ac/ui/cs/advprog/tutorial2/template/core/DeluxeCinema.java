...
public class DeluxeCinema extends Cinema {
    ...
    protected String turnOnAC() {
        return String.format("AC turned on with %s speed", ACSpeed.MEDIUM);
    }
    ...
    protected String playAds() {
        return """
                <div id="iklanDeluxe" class="modal fade" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer" style="justify-content: center;">
                        <p>Ad will be closed in <span id="CDDeluxe">3</span></p>
                      </div>
                    </div>
                  </div>
                </div>""";
